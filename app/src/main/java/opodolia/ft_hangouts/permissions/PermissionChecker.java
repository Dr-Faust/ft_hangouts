...
//		{
//
//			boolean requestPermission = ActivityCompat.shouldShowRequestPermissionRationale(
...
//			}
//			//            else
//			//                permissionExplanation.showLastExplanationDialog(
//			//                        getString(R.string.request_sms_permission_2));
//		}
//	}
//
//	public boolean locationPermissionChecker(Boolean paused)
//	{
//		if (ActivityCompat.checkSelfPermission(mContext, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED
//				|| ActivityCompat.checkSelfPermission(mContext, Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED)
//		{
//			boolean permissionGranted = ActivityCompat.shouldShowRequestPermissionRationale(mActivity, Manifest.permission.ACCESS_FINE_LOCATION)
...
//				};
//				permissionExplanation.showFirstExplanationDialog(Config.REQUEST_LOCATION_PERMISSION, PERMISSIONS,
//						mContext.getString(R.string.request_location_permission_2));
//			} else if (!permissionGranted && !paused)
//				permissionExplanation.showLastExplanationDialog(mContext.getString(R.string.request_location_permission_3));
//			return false;
//		}
//		return true;
//	}
